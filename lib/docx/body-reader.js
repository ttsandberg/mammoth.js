...
function BodyReader(options) {
    ...
    function readRunProperties(element) {
        return readRunStyle(element).map(function(style) {
            ...
            return {
                ...
                font: element.firstOrEmpty("w:rFonts").attributes["w:ascii"] || style.font,
                fontSize: fontSize,
                ...
                fill: readColorValue(element.firstOrEmpty("w:fill").attributes["w:fill"]),
    ...
    var xmlElementReaders = {
        ...
        "w:r": function(element) {
            // console.log(readRunProperties(element.firstOrEmpty("w:rPr")));
            return ReadResult.map(

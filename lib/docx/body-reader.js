...
function BodyReader(options) {
    ...
    function readParagraphProperties(element) {
        console.log('readParagraphProperties element', element);
    ...
    function readRunProperties(element) {
        console.log("readRunProperties", element);
        return readRunStyle(element).map(function(style) {
            console.log("readRunProperties style", style);
    ...
    function readEditAttr(element) {
        var editAttr = {};
        if (element && element.name === 'w:del' && element.attributes) {
    ...
    var xmlElementReaders = {
        "w:p": function(element) {
            ...
            console.log("childrenXml", childrenXml);
        ...
        "w:ins": function(element) {
            ...
            console.log('w:ins resulting props', runProps);
            console.log('w:ins element', element);
            console.log('w:ins children', element.children[0].children);
            return ReadResult.map(
                runProps,
                readXmlElements(element.children[0].children),
                function(properties, children) {
                    var hyperlinkOptions = currentHyperlinkOptions();
                    if (hyperlinkOptions !== null) {
                        children = [new documents.Hyperlink(children, hyperlinkOptions)];
        ...
        "w:del": function(element) {
            ...
            console.log('w:del resulting props', runProps);
            console.log('w:del element', element);
            console.log('w:del children', element.children[0].children);
            return ReadResult.map(
                runProps,
                readXmlElements(element.children[0].children),
                function(properties, children) {
